...
<div class="page-header">
  <div>
    <h1 class="page-header__title">Add Doctor</h1>
    ...
    <form action="<?= base_url('admin/doctors/store') ?>" method="post">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
        <div class="form-group">
          ...
          <input type="text" name="DoctorCode" class="form-control" placeholder="DC006" required>
        </div>
        <div class="form-group">
          <label class="form-label">Full Name</label>
          <input type="text" name="Doctor_name" class="form-control" placeholder="Dr. John Doe" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="Phone" class="form-control" placeholder="08xxxxxxxxx" required>
        </div>
        <div class="form-group">
